<template>
  <div class="div-border">
    ...
    <!-- 操作按钮 -->
    <Button type="info" icon="ios-trash-outline" class="opBtn" @click="clearModal = true" style="margin-bottom:5px">日志清理</Button>
...
<script>
import {log} from 'static/data/staticdata.js'
export default {
  name: 'roleManage',
  data () {
    return {
