<template>
  <div class="div-border">
    ...
    <!-- 操作按钮 -->
    <Button type="info" icon="ios-add-circle-outline" class="opBtn" @click="showAddModal" style="margin-bottom:5px">新增角色</Button>
    <a @click="showDrawer">有疑问？点击查看操作说明</a>
    <!-- 数据表格 -->
    <Table border show-header stripe :columns="columns" :data="data"  @on-sort-change="sortChange"></Table>
...
<script>
import {role} from 'static/data/staticdata.js'
export default {
  name: 'roleManage',
  data () {
    return {
