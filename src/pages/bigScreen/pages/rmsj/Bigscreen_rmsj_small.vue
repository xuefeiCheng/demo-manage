    ...
    <div class="data-content2 data-content2-right">
        <div class="all fl">
          <div class="info">
                ...
                <div id="small_echarts_4"  class="info-concent charts"></div>
          </div>
        </div>
    </div>
  </div>
...
export default {
  ...
  data () {
    return {
      desContent: '展示话题对应的拦截量，显示拦截量前五的话题作为热门事件数据，以漏斗图的形状展示'
    }
  },
  mounted () {
    setTimeout(() => {
  ...
  methods: {
    drawTriangle () { // 基于准备好的dom，初始化echarts实例
      let eChart4 = this.$echarts.init(document.getElementById('small_echarts_4'))
      // 绘制图表
      eChart4.setOption({
