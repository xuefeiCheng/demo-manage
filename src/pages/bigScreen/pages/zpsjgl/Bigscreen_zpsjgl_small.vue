<template>
  <div class="data smallScreen noback">
    ...
    <div class="data-content2">
        <div class="all fl">
          <div class="info">
                <div class="info-title2">疑似诈骗事件</div>
                ...
                <div class="des_content_small" style="height:150px;">{{desContent}}</div>
              ...
              <div class="inter_table_header">
                <ul>
                  <li style="width:11%;text-align:center">编号</li>
                  <li style="width:20%">案件类型</li>
                  <li style="width:16%">案发时间</li>
                  <li style="width:22%">受害人号码</li>
                  <li style="width:27%">受害人所在基站</li>
                </ul>
              </div>
                <div class="inter_table_body" style="height:80%">
                  <div :class="{anim: animate === true}">
                    <ul v-for="item in zpgldata" :key="item.id">
                      <li style="text-align:center;width:11%">{{item.id}}</li>
                      <li class="YELLOW" style="width:20%">{{item.suspect_type}}</li>
                      <li style="width:16%">{{item.caseDate | substr(8, '') }}</li>
                      <li class="YELLOW" style="width:22%;text-align:center">{{item.victimNumber | formatNum6}}</li>
                      <li style="width:27%">{{item.victim_lac}}</li>
                    </ul>
                  </div>
                </div>
            </div>
...
export default {
  ...
  data () {
    return {
      desContent: '查询诈骗案件分析关联的相关呼叫记录、短信等数据。显示：编号、案件类型、案发时间、受害人号码、受害人所在基站等信息，诈骗事件以轮播的方式展示。',
      zpgldata: [
        {
          id: '1',
          suspect_type: '',
