...
(function() {
    ...
    x.K.ha = function(a) {
        ...
        if (a.getBoundingClientRect) {
            ...
            do {
                ...
                f = f.offsetParent
            } while (f && f != a);if (c.opera > 0 || c.nM > 0 && d(a, "position") == "absolute")
    ...
    z.ma = 'static/map/' // 修改，本地工具资源引用(离线路径)
    ...
    var cd = {
        ...
        cb: function(a, b, c, d, e) {
            ...
            ;
            d = d || "";
            b = c && c.JO ? Cb(b, encodeURI) : Cb(b, encodeURIComponent); // b = "qt=s&md=请求路径"
